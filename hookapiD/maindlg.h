...
#pragma comment(lib,"SampleDll.lib") //implicit linking

#include "resource.h"

#define MakePtr(cast, base, offset) (cast)((DWORD_PTR)(base) + (DWORD_PTR)(offset))

extern "C" _declspec(dllexport) int MySymbolCounter(const char *, char, int);
...
public:
	...
	{
		return MessageBoxA("Hello world!");
